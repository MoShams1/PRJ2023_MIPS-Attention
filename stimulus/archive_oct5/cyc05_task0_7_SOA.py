...
Task Procedure:
    ...
    A second set of bars moved orthogonal to the first bar outward (100 ms).
...
output_name = f"cyc05_task0_7_{date}_{time}_{subID}.json"
...
for itrial in range(ntrials):
    ...
    line2_1_motion_array = np.repeat(line2_1_motion_array, 2)

    line2_2_motion_array = [line_start_ypos,
                            line_start_ypos + xshift_steps,
                            line_start_ypos + 2 * xshift_steps]
    line2_2_motion_array = np.repeat(line2_2_motion_array, 2)
