...
Task Procedure:
    ...
    The starting position of the bar was +5 dva from the vertical meridian (
...
output_name = f"cyc05_exp01_barStart5{date}_{time}_{subID}.json"
...
motion_dir_array = np.tile(motion_dir_base, 17 * 1)
