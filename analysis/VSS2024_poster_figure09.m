...
text(4, -.75, ['N = ', num2str(nsub)])
% text(1.5, -.75, 'Leading Probe','HorizontalAlignment','center')
% text(3.5, -.75, 'Trailing Probe','HorizontalAlignment','center')
...
%%
[delta, p1, W, z, r] = signrank_full(y(:,1),y(:,3));
fprintf('<Attention + Motion>  md = %4.1f dva, W = %5d, z = %5.2f, p = %5.3f, r = %4.2f \n', ...
delta,W,z,p1,r)

[delta, p2, W, z, r] = signrank_full(y(:,2),y(:,4));
fprintf('<Motion vs Attention> md = %4.1f dva, W = %5d, z = %5.2f, p = %5.3f, r = %4.2f \n', ...
delta,W,z,p2,r)

[delta, p3, W, z, r] = signrank_full(y(:,4),y(:,3));
fprintf('<Attention>           md = %4.1f dva, W = %5d, z = %5.2f, p = %5.3f, r = %4.2f \n', ...
delta,W,z,p3,r)

[delta, p4, W, z, r] = signrank_full(y(:,2),y(:,3));
fprintf('<Motion>              md = %4.1f dva, W = %5d, z = %5.2f, p = %5.3f, r = %4.2f \n', ...
delta,W,z,p4,r)
...
line([1 2],[3.7 3.7],'linewidth',lw,'color','k')
text(1.5, 3.9, '\it n.s.','HorizontalAlignment','center')

line([3 4],[3.7 3.7],'linewidth',lw,'color','k')
text(3.5, 3.9, '\it n.s.','HorizontalAlignment','center')
