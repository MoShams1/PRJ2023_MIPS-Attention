...
Task Procedure:
    A vertical bar moves either leftward or rightward for 300 ms when then a
    probe flashes. The bar continues to move for another 500 ms.
    The probability of leftward motion trials (bias_factor) can be set for
    each session.
