...
jsonFilePath = '../data/cyc02/MS01_task06_biased_20231026_154242.json';
...
h1 = scatter(err_cell{:,1},err_cell{:,5},'b','o','fill','markerfacealpha',alpha);
h2 = scatter(err_cell{:,2},err_cell{:,6},'b','o');
h3 = scatter(err_cell{:,3},err_cell{:,7},'r','o','fill','markerfacealpha',alpha);
h4 = scatter(err_cell{:,4},err_cell{:,8},'r','o');
